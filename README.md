...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/testflows.asserts-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12207&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/testflows.asserts-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `testflows.asserts` can be installed with:

```
conda install testflows.asserts
```

It is possible to list all of the versions of `testflows.asserts` available on your platform with:
